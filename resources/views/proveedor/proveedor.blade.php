            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white py-3">
                        <h6 class="m-0 font-weight-bold text-success">Registrar De Proveedores</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('proveedor.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre" class="form-control" placeholder="Ej: Empresa S.A."
                                    required>
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-success w-100 shadow-sm">
                                <i class="fas fa-user-plus me-1"></i> Guardar Proveedor
                            </button>
                        </form>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group shadow-sm">
                                                ...
                                                <form action="{{ route('proveedor.estado', $p->id) }}" method="POST">
                                                    @csrf @method('PUT')
                                                    <button class="btn btn-sm text-danger border-0"><i
